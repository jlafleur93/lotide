...
console.log(`equal values`, (eqObjects(bc,bb)));
console.log(`unequal values meant to fail 2`, eqObjects(bb, abc));
console.log(`different ordered values:`,eqObjects(bb, diffOrderbb))